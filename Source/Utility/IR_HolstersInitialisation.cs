...
namespace RimWorldHolsters
{
    ...
    public static class IR_HolstersInitialisation
    {
        static IR_HolstersInitialisation()
        {
        ...
        public static List<HolsterWeaponRenderGroup> LoadDefaultWeaponGroups()
        {
            ...
            {
                new HolsterWeaponRenderGroup("Long Ranged")
                {
                    HolsterRenderData = new HolsterRenderData
                    {
                        Configuration = new Dictionary<Rot4, HolsterConfiguration>
                        {
                            { Rot4.South, new HolsterConfiguration(new Vector3(-1f, 0, 1f), 255f, 1f, true, false, new Vector3(0f, 0, 0f)) },
                            { Rot4.North, new HolsterConfiguration(new Vector3(0f, 0, 0f), 310f, 1f, false, true, new Vector3(0f, 0, 0f)) },
                            { Rot4.East,  new HolsterConfiguration(new Vector3(-2f, 0, 0f), 295f, 1f, false, true, new Vector3(-2f, 0, 0f)) },
                            { Rot4.West,  new HolsterConfiguration(new Vector3(2f, 0, 0f), 255f, 1f, true, false, new Vector3(2f, 0, 0f)) }
                        },
                        SideConfiguration = new Dictionary<Rot4, HolsterConfiguration>
                        {
                            { Rot4.South, new HolsterConfiguration(new Vector3(1.5f, 0, 0f), 275f, 1f, false, false, new Vector3(1f, 0, 0f)) },
                ...
                new HolsterWeaponRenderGroup("Short Ranged")
                {
                    HolsterRenderData = new HolsterRenderData
                    {
                        Configuration = new Dictionary<Rot4, HolsterConfiguration>
                        {
                            { Rot4.South, new HolsterConfiguration(new Vector3(1.5f, 0, -2.5f), 140f, 1f, true, true, new Vector3(2f, 0, -0.5f)) },
                            { Rot4.North, new HolsterConfiguration(new Vector3(-1.5f, 0, -2.5f), 25f, 1f, false, false, new Vector3(-2f, 0, -0.5f)) },
                            { Rot4.East,  new HolsterConfiguration(new Vector3(1f, 0, -2.5f), 25f, 1f, false, false, new Vector3(-2f, 0, 0f)) },
                            { Rot4.West,  new HolsterConfiguration(new Vector3(-0.5f, 0, -2.5f), 145f, 1f, true, true, new Vector3(2f, 0, 0f)) }
                        },
                        SideConfiguration = new Dictionary<Rot4, HolsterConfiguration>
                        {
                            { Rot4.South, new HolsterConfiguration(new Vector3(-1.5f, 0, -2.5f), 40f, 1f, false, true, new Vector3(-2f, 0, -0.5f)) },
                ...
                new HolsterWeaponRenderGroup("Bows")
                {
                    HolsterRenderData = new HolsterRenderData
                    {
                        Configuration = new Dictionary<Rot4, HolsterConfiguration>
                        {
                            { Rot4.South, new HolsterConfiguration(new Vector3(-0.5f, 0, 0f), 135f, 1f, false, false, new Vector3(0f, 0, 0f)) },
                            { Rot4.North, new HolsterConfiguration(new Vector3(0f, 0, 0f), 35f, 1f, false, true, new Vector3(0f, 0, 0f)) },
                            { Rot4.East,  new HolsterConfiguration(new Vector3(-2f, 0, 0f), 20f, 1f, false, true, new Vector3(-1f, 0, 0f)) },
                            { Rot4.West,  new HolsterConfiguration(new Vector3(2f, 0, 0f), 340f, 1f, false, false, new Vector3(1f, 0, 0f)) }
                        },
                        SideConfiguration = new Dictionary<Rot4, HolsterConfiguration>
                        {
                            { Rot4.South, new HolsterConfiguration(new Vector3(0.5f, 0, -1.5f), 110f, 1f, false, false, new Vector3(0f, 0, 0f)) },
                ...
                new HolsterWeaponRenderGroup("Long Melee")
                {
                    HolsterRenderData = new HolsterRenderData
                    {
                        Configuration = new Dictionary<Rot4, HolsterConfiguration>
                        {
                            { Rot4.South, new HolsterConfiguration(new Vector3(-0.5f, 0, 0.5f), 55f, 1f, true, false, new Vector3(0f, 0, 0.5f)) },
                            { Rot4.North, new HolsterConfiguration(new Vector3(0.5f, 0, -0.5f), 120f, 1f, false, true, new Vector3(0f, 0, 0.5f)) },
                            { Rot4.East,  new HolsterConfiguration(new Vector3(-2f, 0, 0f), 110f, 1f, false, true, new Vector3(-2f, 0, 0f)) },
                            { Rot4.West,  new HolsterConfiguration(new Vector3(2f, 0, 0f), 75f, 1f, true, false, new Vector3(2f, 0, 0f)) }
                        },
                        SideConfiguration = new Dictionary<Rot4, HolsterConfiguration>
                        {
                            { Rot4.South, new HolsterConfiguration(new Vector3(-1.5f, 0, -0.5f), 55f, 1f, false, false, new Vector3(0f, 0, 0f)) },
                ...
                new HolsterWeaponRenderGroup("Short Melee")
                {
                    HolsterRenderData = new HolsterRenderData
                    {
                        Configuration = new Dictionary<Rot4, HolsterConfiguration>
                        {
                            { Rot4.South, new HolsterConfiguration(new Vector3(1.5f, 0, -2f), 60f, 0.8f, true, true, new Vector3(2f, 0, 0f)) },
                            { Rot4.North, new HolsterConfiguration(new Vector3(-1.5f, 0, -2f), 110f, 0.8f, false, false, new Vector3(-2f, 0, 0f)) },
                            { Rot4.East,  new HolsterConfiguration(new Vector3(0.5f, 0, -2f), 135f, 0.8f, false, false, new Vector3(-1f, 0, 0f)) },
                            { Rot4.West,  new HolsterConfiguration(new Vector3(-0.5f, 0, -2f), 50f, 0.8f, true, true, new Vector3(1f, 0, 0f)) }
                        },
                        SideConfiguration = new Dictionary<Rot4, HolsterConfiguration>
                        {
                            { Rot4.South, new HolsterConfiguration(new Vector3(-1.5f, 0, -2f), 115f, 0.8f, false, true, new Vector3(-2f, 0, 0f)) },
                ...
                new HolsterWeaponRenderGroup("Grenades")
                {
                    HolsterRenderData = new HolsterRenderData
                    {
                        Configuration = new Dictionary<Rot4, HolsterConfiguration>
                        {
                            { Rot4.South, new HolsterConfiguration(new Vector3(0.5f, 0, -2.5f), -20f, 0.6f, false, true, new Vector3(-1f, 0, -0.5f)) },
                            { Rot4.North, new HolsterConfiguration(new Vector3(-0.5f, 0, -2.5f), 320f, 0.6f, false, false, new Vector3(1f, 0, -0.5f)) },
                            { Rot4.East,  new HolsterConfiguration(new Vector3(1f, 0, -2.5f), 280f, 0.6f, false, false, new Vector3(1f, 0, 0f)) },
                            { Rot4.West,  new HolsterConfiguration(new Vector3(-1f, 0, -2.5f), 30f, 0.6f, false, true, new Vector3(-1f, 0, 0f)) }
                        },
                        SideConfiguration = new Dictionary<Rot4, HolsterConfiguration>
                        {
                            { Rot4.South, new HolsterConfiguration(new Vector3(-1.5f, 0, -2f), 10f, 0.6f, false, true, new Vector3(-1.5f, 0, 0f)) },
